...
void cuda_list_attributes(int cuda_dev) {
  {
    ...
    printf("cudaDevAttrComputeMode........................... = %d (Compute "
    ...
    printf("cudaDevAttrConcurrentKernels..................... = %d (1 if the "
    ...
    printf("cudaDevAttrMaxRegistersPerMultiprocessor......... = %d (Maximum "
    ...
    printf("cudaDevAttrPageableMemoryAccess.................. = %d (1 if the "
    ...
    printf("cudaDevAttrCooperativeLaunch..................... = %d (1 if the "
    ...
    printf("cudaDevAttrCooperativeMultiDeviceLaunch.......... = %d (1 if the "
    ...
    printf("cudaDevAttrDirectManagedMemAccessFromHost........ = %d (1 if the "
    ...
    printf("cudaDevAttrMaxSharedMemoryPerBlockOptin.......... = %d (Maximum "
...
void cuda_list_limits(int cuda_dev) {
  {
    ...
    printf("cudaLimitStackSize................... = %lu (stack size in bytes "
           "of each GPU thread)\n",
           val);
    check_cuda_errors(cudaDeviceGetLimit(&val, cudaLimitPrintfFifoSize));
    printf("cudaLimitPrintfFifoSize.............. = %lu (size in bytes of the "
           "shared FIFO used by the printf() devicesystem call)\n",
           val);
    check_cuda_errors(cudaDeviceGetLimit(&val, cudaLimitMallocHeapSize));
    printf("cudaLimitMallocHeapSize.............. = %lu (size in bytes of the "
    ...
    printf(
        "cudaLimitDevRuntimeSyncDepth......... = %lu (maximum grid depth at "
    ...
    printf("cudaLimitMaxL2FetchGranularity....... = %lu (L2 cache fetch "
           "granularity.)\n",
           val);
  }
}
