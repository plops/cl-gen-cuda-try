...
float complex *fft_21_3_7(float complex *__restrict__ x) {
  ...
  {
    static alignas(64) float complex x2[21] = {(0.0e+0f)};
    ...
    x2[1] = x1[1];
    x2[8] = (x1[8] * w21m1_21);
    x2[15] = (x1[15] * w21p19_21);
    x2[2] = x1[2];
    x2[9] = (x1[9] * w21p19_21);
    x2[16] = (x1[16] * w21p17_21);
    x2[3] = x1[3];
    x2[10] = (x1[10] * w21p6_7);
    x2[17] = (x1[17] * w21p5_7);
    x2[4] = x1[4];
    x2[11] = (x1[11] * w21p17_21);
    x2[18] = (x1[18] * w21p13_21);
    x2[5] = x1[5];
    x2[12] = (x1[12] * w21p16_21);
    x2[19] = (x1[19] * w21p11_21);
    x2[6] = x1[6];
    x2[13] = (x1[13] * w21p5_7);
    x2[20] = (x1[20] * w21p3_7);
  }
  // another dft;
  {
    static alignas(64) float complex x3[21] = {(0.0e+0f)};
