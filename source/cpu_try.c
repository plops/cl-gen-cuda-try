  ...
  // n1 DFTs of size n2 in the column direction;
  {
    ...
    // multiply with twiddle factors and transpose;
    {
      ...
      // another dft;
      {
        ...
        x3[0] = (x2[0] + x2[1] + x2[2]);
        x3[7] = (x2[0] + (x2[1] * w3m1_3) + (x2[2] * w3p1_3));
        x3[14] = (x2[0] + (x2[1] * w3p1_3) + (x2[2] * w3m1_3));
        x3[1] = (x2[3] + x2[4] + x2[5]);
        x3[8] = (x2[3] + (x2[4] * w3m1_3) + (x2[5] * w3p1_3));
        x3[15] = (x2[3] + (x2[4] * w3p1_3) + (x2[5] * w3m1_3));
        x3[2] = (x2[6] + x2[7] + x2[8]);
        x3[9] = (x2[6] + (x2[7] * w3m1_3) + (x2[8] * w3p1_3));
        x3[16] = (x2[6] + (x2[7] * w3p1_3) + (x2[8] * w3m1_3));
        x3[3] = (x2[9] + x2[10] + x2[11]);
        x3[10] = (x2[9] + (x2[10] * w3m1_3) + (x2[11] * w3p1_3));
        x3[17] = (x2[9] + (x2[10] * w3p1_3) + (x2[11] * w3m1_3));
        x3[4] = (x2[12] + x2[13] + x2[14]);
        x3[11] = (x2[12] + (x2[13] * w3m1_3) + (x2[14] * w3p1_3));
        x3[18] = (x2[12] + (x2[13] * w3p1_3) + (x2[14] * w3m1_3));
        x3[5] = (x2[15] + x2[16] + x2[17]);
        x3[12] = (x2[15] + (x2[16] * w3m1_3) + (x2[17] * w3p1_3));
        x3[19] = (x2[15] + (x2[16] * w3p1_3) + (x2[17] * w3m1_3));
        x3[6] = (x2[18] + x2[19] + x2[20]);
        x3[13] = (x2[18] + (x2[19] * w3m1_3) + (x2[20] * w3p1_3));
