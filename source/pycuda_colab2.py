...
__global__ void fft_21_3_7(complex *dst, complex *src) {
  // n1 DFTs of size n2 in the column direction;
  {
    ...
    x1[0] = cuCaddf(
        cuCaddf(x[0], x[3]),
        cuCaddf(cuCaddf(x[6], x[9]), cuCaddf(cuCaddf(x[12], x[15]), x[18])));
    x1[1] = cuCaddf(
        cuCaddf(x[1], x[4]),
        cuCaddf(cuCaddf(x[7], x[10]), cuCaddf(cuCaddf(x[13], x[16]), x[19])));
    x1[2] = cuCaddf(
        cuCaddf(x[2], x[5]),
        cuCaddf(cuCaddf(x[8], x[11]), cuCaddf(cuCaddf(x[14], x[17]), x[20])));
    x1[3] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7m1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7p5_7), cuCmulf(x[9], w7p4_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7p3_7), cuCmulf(x[15], w7p2_7)),
                        cuCmulf(x[18], w7p1_7))));
    x1[4] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7m1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7p5_7), cuCmulf(x[10], w7p4_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7p3_7), cuCmulf(x[16], w7p2_7)),
                        cuCmulf(x[19], w7p1_7))));
    x1[5] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7m1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7p5_7), cuCmulf(x[11], w7p4_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7p3_7), cuCmulf(x[17], w7p2_7)),
                        cuCmulf(x[20], w7p1_7))));
    x1[6] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7p5_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7p3_7), cuCmulf(x[9], w7p1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7m1_7), cuCmulf(x[15], w7p4_7)),
                        cuCmulf(x[18], w7p2_7))));
    x1[7] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7p5_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7p3_7), cuCmulf(x[10], w7p1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7m1_7), cuCmulf(x[16], w7p4_7)),
                        cuCmulf(x[19], w7p2_7))));
    x1[8] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7p5_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7p3_7), cuCmulf(x[11], w7p1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7m1_7), cuCmulf(x[17], w7p4_7)),
                        cuCmulf(x[20], w7p2_7))));
    x1[9] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7p4_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7p1_7), cuCmulf(x[9], w7p5_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7p2_7), cuCmulf(x[15], w7m1_7)),
                        cuCmulf(x[18], w7p3_7))));
    x1[10] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7p4_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7p1_7), cuCmulf(x[10], w7p5_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7p2_7), cuCmulf(x[16], w7m1_7)),
                        cuCmulf(x[19], w7p3_7))));
    x1[11] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7p4_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7p1_7), cuCmulf(x[11], w7p5_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7p2_7), cuCmulf(x[17], w7m1_7)),
                        cuCmulf(x[20], w7p3_7))));
    x1[12] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7p3_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7m1_7), cuCmulf(x[9], w7p2_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7p5_7), cuCmulf(x[15], w7p1_7)),
                        cuCmulf(x[18], w7p4_7))));
    x1[13] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7p3_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7m1_7), cuCmulf(x[10], w7p2_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7p5_7), cuCmulf(x[16], w7p1_7)),
                        cuCmulf(x[19], w7p4_7))));
    x1[14] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7p3_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7m1_7), cuCmulf(x[11], w7p2_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7p5_7), cuCmulf(x[17], w7p1_7)),
                        cuCmulf(x[20], w7p4_7))));
    x1[15] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7p2_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7p4_7), cuCmulf(x[9], w7m1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7p1_7), cuCmulf(x[15], w7p3_7)),
                        cuCmulf(x[18], w7p5_7))));
    x1[16] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7p2_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7p4_7), cuCmulf(x[10], w7m1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7p1_7), cuCmulf(x[16], w7p3_7)),
                        cuCmulf(x[19], w7p5_7))));
    x1[17] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7p2_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7p4_7), cuCmulf(x[11], w7m1_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7p1_7), cuCmulf(x[17], w7p3_7)),
                        cuCmulf(x[20], w7p5_7))));
    x1[18] = cuCaddf(
        cuCaddf(x[0], cuCmulf(x[3], w7p1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[6], w7p2_7), cuCmulf(x[9], w7p3_7)),
                cuCaddf(cuCaddf(cuCmulf(x[12], w7p4_7), cuCmulf(x[15], w7p5_7)),
                        cuCmulf(x[18], w7m1_7))));
    x1[19] = cuCaddf(
        cuCaddf(x[1], cuCmulf(x[4], w7p1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[7], w7p2_7), cuCmulf(x[10], w7p3_7)),
                cuCaddf(cuCaddf(cuCmulf(x[13], w7p4_7), cuCmulf(x[16], w7p5_7)),
                        cuCmulf(x[19], w7m1_7))));
    x1[20] = cuCaddf(
        cuCaddf(x[2], cuCmulf(x[5], w7p1_7)),
        cuCaddf(cuCaddf(cuCmulf(x[8], w7p2_7), cuCmulf(x[11], w7p3_7)),
                cuCaddf(cuCaddf(cuCmulf(x[14], w7p4_7), cuCmulf(x[17], w7p5_7)),
                        cuCmulf(x[20], w7m1_7))));
