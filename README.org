...
Although this approach is very simple, it gives access to the expressiveness 
of Commmon Lisp macros. I can easily play around with different code
...
| gen-pycuda-colab.lisp  |                |                                                                                                                                     |   |   |
| gen-pycuda-colab2.lisp |                |                                                                                                                                     |   |   |
| hex.lisp               |                | hex representation for floating point constants. i use this in computer generated constants like twiddle factors for fft            |   |   |
...
- gcc simd https://gcc.gnu.org/onlinedocs/gcc/Vector-Extensions.html
  ...
  - complex with eigen https://stackoverflow.com/questions/45298855/how-to-write-portable-simd-code-for-complex-multiplicative-reduction
    - store real and imaginary parts in a way that they
      can be directly loaded one packet at once, interleaved is not
      good
    - -mfma -mavx512f
